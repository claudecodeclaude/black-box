...
let overBuffer = [];
let sendTimer = null;
const SEND_TAIL_RE = /\b(send|sent|said|sind|senned|scend|sand|sound|end|ten|and)[\s.!?,]*$/i;
const SEND_STRIP_RE = /\s*\b(send|sent|said|sind|senned|scend|sand|sound|end|ten|and)\b[\s.!?,]*$/i;
